...
// Source: github.com/tkircsi/simple-bank/db/sqlc (interfaces: Store)
...
// CleanUpDB mocks base method.
func (m *MockStore) CleanUpDB(arg0 context.Context) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CleanUpDB", arg0)
	ret0, _ := ret[0].(error)
	return ret0
}

// CleanUpDB indicates an expected call of CleanUpDB.
func (mr *MockStoreMockRecorder) CleanUpDB(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CleanUpDB", reflect.TypeOf((*MockStore)(nil).CleanUpDB), arg0)
}
